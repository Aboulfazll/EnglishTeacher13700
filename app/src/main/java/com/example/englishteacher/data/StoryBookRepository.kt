...
object StoryBookRepository {
    ...
    fun getAllStories(): List<Story> = listOf(
        ...
        Story(
            ...
            level = Level.INTERMEDIATE,
            text = "A young farmer planted a bamboo seed. He watered it every day. After a year, nothing grew. His neighbors laughed at him. \"You are wasting your time!\" they said. But the farmer kept watering. In the fifth year, a bamboo shoot appeared. In just six weeks, it grew thirty meters tall. The roots had been growing underground all along.",
